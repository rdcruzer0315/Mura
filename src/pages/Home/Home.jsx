    ...
    return (
        ...
        <div className="lg:mt-40 mt-20 flex lg:flex-row">
            ...
            <div className="w-1/2 flex flex-col justify-center items-center">
                ...
                <p className="font-semibold text-black lg:text-xl text-xs text-center lg:mt-6 mt-3">Open Until 7 PM</p>
        ...
        <div className="lg:mt-10 mt-5 flex flex-row">
            <div className="w-1/2 flex flex-col justify-center items-center">
                ...
                <p className="font-semibold text-black lg:text-xl text-xs text-center lg:mt-6 mt-3">BRUNCH - Open Until 5 PM</p>
                <p className="font-semibold text-black lg:text-xl text-xs text-center lg:mt-6 mt-3">DINNER - Close 5 PM</p>
