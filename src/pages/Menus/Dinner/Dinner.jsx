...
import { getDinnerImages } from "../../../store/Dinner";
...
const Dinner = () => {
    ...
    const items = useSelector((state) => state.dinner.images);
        ...
        <div className='bg-[#F5ECE6] xl:mx-60 lg:mx-20 mx-4'>
            <div className="lg:mt-24 mt-10 flex lg:flex-row flex-col justify-center items-center">
                ...
                <div className="lg:w-1/2 w-full lg:pl-5 lg:pt-0 pt-5">
                    <img className="rounded-lg" src="assets/Menu/Dinner/dinner1.png" alt="dinner_logo"/>
                </div>
            </div>
