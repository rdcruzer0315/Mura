...
const FAQ = () => {
    return (
        ...
        <div className="mt-10">
            <p className="text-black lg:text-2xl text-xl text-center font-bold">Can I make reservations for dine in?</p>
            <div className="mt-3 grid grid-cols-9">
                <p className="relative text-black lg:text-lg text-base text-left flex justify-center col-start-4 col-span-3 font-semibold pb-12 border-b-2 border-[#ACABAB]">
        ...
        <div className="mt-10">
            <p className="text-black lg:text-2xl text-xl text-center font-bold">I have dietary restrictions. Can I find other options in Mura?</p>
            <div className="mt-3 grid grid-cols-9">
                <p className="relative text-black lg:text-lg text-base text-left flex justify-center col-start-4 col-span-3 font-semibold pb-12 border-b-2 border-[#ACABAB]">
        ...
        <div className="mt-10">
            <p className="text-black lg:text-2xl text-xl text-center font-bold">How does the conveyor belt system work?</p>
            <div className="mt-3 grid grid-cols-9">
                <p className="relative text-black lg:text-lg text-base text-left flex justify-center col-start-4 col-span-3 font-semibold pb-12 border-b-2 border-[#ACABAB]">
