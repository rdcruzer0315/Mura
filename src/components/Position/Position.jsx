...
const Position = ({ role, type, idx,  uploadResume, saveRole }) => {
    ...
    return (
        <>
        <div className="bg-[#F5ECE6] rounded py-4 lg:px-12 px-2 cursor-pointer lg:w-72 w-36 flex flex-col justify-center mt-8" onClick={(e) => {uploadResume(); saveRole(role, type, idx);}}>
