    ...
    <div className="relative text-{2F2F2F} px-3 py-2 rounded-md text-normal font-weight-500">
      ...
      {menuOpen && (
        <ul id="dropdownMenu" className="absolute z-10 mt-2 py-2 w-40 lg:bg-transparent bg-white rounded-md">
          <li><NavLink to="/cafe" className="block py-2 lg:pl-0 pl-3">CAFE MENU</NavLink></li>
          <li><NavLink to="/dinner" className="block py-2 lg:pl-0 pl-3">DINNER MENU</NavLink></li>
          <li><NavLink to="/bar" className="block py-2 lg:pl-0 pl-3">BAR MENU</NavLink></li>
        </ul>
      )}
    </div>
  );
